...
print(f"\nСкладываем клетки1 = {cell_obj1} и клетку2 ={cell_obj2}")
print(f"Результат равен --> {cell_obj1 + cell_obj2}")
print(f"\nВычитаем клетку2 = {cell_obj2} из клетки4 ={cell_obj4}")
print(f"Результат равен --> {cell_obj2 - cell_obj4}")
print(f"\nДелим клетку4 = {cell_obj4} на клетку1 ={cell_obj1}")
print(f"Результат равен --> {cell_obj4 / cell_obj1}")
print(f"\nУиножаем клетку3 = {cell_obj3} на клетку2 ={cell_obj2}")
print(f"Результат равен --> {cell_obj3 * cell_obj2}")

print("Организация ячеек по рядам")
print(cell_obj2.make_order(5))
print(cell_obj4.make_order(10))